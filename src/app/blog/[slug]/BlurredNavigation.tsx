...
export default function BlurredNavigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-out border-b border-gray-200/50 dark:border-gray-700/50 ${
      isScrolled
    ...
    style={{
      ...
      <div className="max-w-3xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <Link
            href="/"
            className="text-lg font-semibold transition-all duration-300 hover:scale-105 text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400"
          >
            jinukeu.log
          </Link>
