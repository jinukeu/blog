...
export default function BlurredNavigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 border-b ${
      isScrolled
        ? 'backdrop-blur-sm bg-white/90 dark:bg-gray-900/90 border-gray-200 dark:border-gray-700'
      ...
      <div className="max-w-[900px] mx-auto px-8 py-4">
        <div className="flex justify-between items-center">
          <Link
            href="/"
            className="text-xl font-bold transition-colors text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300"
          >
            jinukeu
          </Link>
