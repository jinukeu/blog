...
export default function BlurredNavigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-out ${
      isScrolled
        ? 'backdrop-blur-xl bg-white/80 dark:bg-gray-900/80 border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm'
        : 'bg-transparent'
    }`}
    style={{
      ...
      <div
        className={`h-px bg-gradient-to-r from-transparent via-gray-300/60 dark:via-gray-600/60 to-transparent transition-opacity duration-300 ${
